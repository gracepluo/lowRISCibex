...
void VFIFO_tb___024root__trace_decl_types(VerilatedFst* tracep);

void VFIFO_tb___024root__trace_init_top(VFIFO_tb___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void VFIFO_tb::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'VFIFO_tb::trace()' called on non-VerilatedFstC object;"
