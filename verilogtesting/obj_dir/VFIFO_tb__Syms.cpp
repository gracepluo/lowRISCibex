    ...
    , TOP{this, namep}
{
    ...
    // Setup scopes
    __Vscope_FIFO_tb.configure(this, name(), "FIFO_tb", "FIFO_tb", -12, VerilatedScope::SCOPE_OTHER);
    __Vscope_FIFO_tb__unnamedblk2.configure(this, name(), "FIFO_tb.unnamedblk2", "unnamedblk2", -12, VerilatedScope::SCOPE_OTHER);
}
